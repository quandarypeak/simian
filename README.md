...
| ignoreCurlyBraces     | Java, C#, C, C++, JavaScript, Python, Ruby, Groovy     | false   | boolean                                                                                                                   | Curly braces are ignored.                                                                                                                          |
| ignoreIdentifiers     | Java, C#, C, C++, JavaScript, COBOL, Python, Ruby, Groovy | false   | boolean                                                                                                                   | Completely ignores all identifiers.                                                                                                                |
| ignoreIdentifierCase  | Java, C#, C, C++, JavaScript, COBOL, Python, Ruby, Groovy | true    | boolean                                                                                                                   | Matches identifiers irrespective of case, e.g. `MyVariableName` and `myvariablename` would both match.                                             |
| ignoreRegions         | C#                                                     | false   | boolean                                                                                                                   | Ignore lines between `#region`/`#endregion`.                                                                                                       |
| ignoreStrings         | Java, C#, C, C++, JavaScript, COBOL, Python, Ruby, SQL, Groovy | false   | boolean                                                                                                                   | `MyVariable` and `myvariable` would both match.                                                                                                    |
| ignoreStringCase      | Java, C#, C, C++, JavaScript, COBOL, Python, Ruby, SQL, Groovy | true    | boolean                                                                                                                   | `"Hello, World"` and `"HELLO, WORLD"` would both match.                                                                                            |
| ignoreNumbers         | Java, C#, C, C++, JavaScript, COBOL, Python, Ruby, SQL, Groovy | false   | boolean                                                                                                                   | `int x = 1;` and `int x = 576;` would both match.                                                                                                  |
...
| ignoreLiterals        | Java, C#, C, C++, JavaScript, COBOL, Python, Ruby, SQL, Groovy | false   | boolean                                                                                                                   | `'A'`, `"one"` and `27.8` would all match.                                                                                                         |
| ignoreSubtypeNames    | Java, C, Python, Groovy                               | false   | boolean                                                                                                                   | `BufferedReader`, `StringReader` and `Reader` would all match.                                                                                     |
| ignoreModifiers       | Java, C#, C, C++, JavaScript, Python, Groovy           | true    | boolean                                                                                                                   | Ignores modifiers such as `public`, `protected`, `static`, `async`, etc.                                                                           |
| ignoreVariableNames   | Java, C, Python, Groovy                               | false   | boolean                                                                                                                   | Completely ignores variable names (field, parameter and local), e.g. `int foo = 1;` and `int bar = 1` would both match.                            |
| balanceParentheses    | Java, C#, C, C++, JavaScript, COBOL, Python, Ruby, SQL, Groovy | false   | boolean                                                                                                                   | Ensures that expressions inside parentheses split across multiple physical lines are considered as one.                                            |
...
| balanceSquareBrackets | Java, C#, C, C++, JavaScript, Python, Ruby, Groovy    | false   | boolean                                                                                                                   | Ensures that expressions inside square brackets split across multiple physical lines are considered as one; defaults to false.                      |
